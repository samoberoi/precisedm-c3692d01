    ...
    <div className="min-h-screen bg-background pb-36 md:pb-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between px-5 pt-12 pb-3 md:pt-8">
          ...
          <h1 className="text-lg md:text-2xl font-bold text-foreground md:w-full">Connect</h1>
        ...
        <div className="px-5 pt-2">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl h-[180px] md:h-[260px]"
            style={{
        ...
        {/* Contact Cards + Form in 2-col on desktop */}
        <div className="md:grid md:grid-cols-2 md:gap-6 px-5 pt-5">
          <div>
            {/* Contact Cards */}
            <div className="grid grid-cols-2 gap-3 md:grid-cols-1">
              <a href="tel:612-916-4059" className="flex flex-col items-start rounded-2xl bg-card border border-border shadow-sm p-4 active:scale-[0.97] hover:scale-[1.01] transition-transform">
              ...
              <a href="mailto:precise.diabetes@gmail.com" className="flex flex-col items-start rounded-2xl bg-[hsl(200,30%,18%)] shadow-lg p-4 active:scale-[0.97] hover:scale-[1.01] transition-transform">
          ...
          <div className="pt-5 md:pt-0">
            <h2 className="text-[22px] md:text-xl font-extrabold text-foreground tracking-tight mb-4">Send a Message</h2>
            <motion.form
