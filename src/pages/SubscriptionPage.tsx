          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{subscription.plan_type === "monthly" ? "Monthly" : "Yearly"} Plan</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground mb-4">Next renewal: <span className="font-semibold text-foreground">{daysRemaining} days</span></p>
