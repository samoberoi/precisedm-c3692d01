...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "PreciseDM's Gestational Module is built for exactly this. It accounts for gestational age, changing insulin sensitivity across trimesters, and patient-specific inputs, providing structured, individualised guidance that the clinician can evaluate and apply in the context of the patient in front of them." },
    ...
    faqs: [
      ...
      { q: "How does PreciseDM support clinical decision-making in gestational diabetes?", a: "PreciseDM's Gestational Module provides structured, patient-specific insulin dosing guidance for clinicians managing gestational diabetes. It accounts for pregnancy-specific variables including gestational age and trimester-related insulin sensitivity shifts, offering individualised guidance the clinician can evaluate and act upon with their clinical judgment fully intact. It is available on web and mobile for access at the point of care." },
    ],
  },
];
